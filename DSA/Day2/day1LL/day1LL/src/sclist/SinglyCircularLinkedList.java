...
public class SinglyCircularLinkedList {
	...
	public void checkCircularity(int n) { //if given nodes are 5 and given value is n=8 then tail 
		                          //is connected to head and then 5+3 next 3 nodes will be starting from head - 3rd node
		SCNode temp=head;			//i.e the circular link is formed
		int i=1;
		while(i<=n)
		{
